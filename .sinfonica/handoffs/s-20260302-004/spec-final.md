# Technical Specification: Sinfonica Orchestration Framework (Retrospective Baseline)

## 1) Scope and Objective

This specification translates the approved retrospective PRD baseline into implementation-ready architecture contracts for Sinfonica's local-first orchestration runtime.
...
- Rule transparency SLO: `sinfonica rules --json` returns parseable output in 100% of CI runs.
...
- `sinfonica rules --json` is informational and returns exit code `0`.
...
- `.sinfonica/handoffs/s-20260302-004/return-02-libretto.md`
