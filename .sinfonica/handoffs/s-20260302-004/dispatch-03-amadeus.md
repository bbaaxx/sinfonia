...
Create the technical specification from the approved retrospective PRD baseline for Sinfonica.

## Inputs

- Canonical PRD artifact: `.sinfonica/handoffs/s-20260302-004/prd-final.md`
- PRD return envelope: `.sinfonica/handoffs/s-20260302-004/return-02-libretto.md`
- Published docs copy (non-canonical): `docs/prd/sinfonica-retrospective-prd.md`
