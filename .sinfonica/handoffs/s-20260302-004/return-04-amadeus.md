...
Authored the implementation-ready technical specification for the approved Sinfonica retrospective PRD baseline. The spec defines explicit module boundaries, canonical contracts (workflow index, handoff envelopes, routing map, enforcement rules), validation invariants, runtime data flows, API-level pre/post-conditions, dependency-ordered implementation units, and FR-to-test traceability. It also carries forward and resolves the three required decisions from dispatch (operational adoption SLOs, compatibility policy window, and enforcement configurability model).

## Artifacts

- `.sinfonica/handoffs/s-20260302-004/spec-final.md` (created)
- `.sinfonica/handoffs/s-20260302-004/return-04-amadeus.md` (created)
