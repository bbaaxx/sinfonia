...
- Delegate: `@sinfonica-amadeus`
- Date: `2026-03-02`

## Objective

Produce a concise, implementation-ready technical specification for handling a routed maestro request that loads skill context from `.opencode/skills/sinfonica-create-spec/SKILL.md` and generates a task prompt for `sinfonica-maestro`.

## Inputs

- Skill instructions: `.opencode/skills/sinfonica-create-spec/SKILL.md`
- Normalized request and workflow state: `.sinfonica/handoffs/s-20260302-005/workflow.md`
...
`@sinfonica-amadeus` please read and execute this dispatch envelope and write your return envelope in this same session directory.
