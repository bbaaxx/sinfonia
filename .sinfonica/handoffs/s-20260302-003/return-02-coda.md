...
- Updated Maestro Subagent Orchestration Protocol table (`When to spawn`) to route `sinfonica-metronome` on context-pressure/compaction needs rather than QA/test planning.
...
- Modified: `.opencode/agent/sinfonica-maestro.md`
