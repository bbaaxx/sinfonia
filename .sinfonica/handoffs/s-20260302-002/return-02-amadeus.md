...
# Return Envelope: @sinfonica-amadeus -> @sinfonica-maestro
...
1. **Primary voice source (highest leverage)**
   ...
   - `.opencode/agent/sinfonica-maestro.md`: generated runtime stub consumed by the host; mirrors `agents/maestro.md` body.
...
2. **Persona propagation and customization boundaries**
   ...
   - `src/persona/loader.ts`: resolves framework vs `.sinfonica/agents` overrides (enables project-level tone customization).
...
| --------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------- | --------------------------------------------------------------------------- |
| A. Prompt/persona-instruction updates only                      | `agents/maestro.md` (+ regenerated `.opencode/agent/sinfonica-maestro.md`)                                    | **Medium-High** for perceived friendliness, low latency to impact                | **Low-Medium** (risk of drifting into verbosity/less crisp gating language)                  | **Low** code effort; update persona validation and snapshot-like tests      | **High** if workflow semantics unchanged                                    |
...
3. Persona validation passes with updated Maestro content (`sinfonica validate` equivalent checks for section/content rules).
...
- Created: `.sinfonica/handoffs/s-20260302-002/return-02-amadeus.md`
