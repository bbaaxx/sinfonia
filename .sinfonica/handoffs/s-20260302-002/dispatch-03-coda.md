# Dispatch Envelope: Stage 02 -> @sinfonica-coda
...
Use the evaluation return at `.sinfonica/handoffs/s-20260302-002/return-02-amadeus.md` as design input.
...
3. Regenerate or align generated persona artifacts if repository conventions require it (e.g., `.opencode/agent/sinfonica-maestro.md`).
