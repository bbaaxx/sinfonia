...
- File path: `docs/SINFONICA_QUICK_PRIME.md`
...
2. Place file at root of docs folder exactly as: `docs/SINFONICA_QUICK_PRIME.md`.
...
1. New file `docs/SINFONICA_QUICK_PRIME.md` created.
2. Content covers:
   - What Sinfonica is in this repo
...
- [ ] File exists at `docs/SINFONICA_QUICK_PRIME.md`
- [ ] Line count <= 200
