...
# Return Envelope: @sinfonica-coda -> @sinfonica-maestro

## Summary

Created `docs/SINFONICA_QUICK_PRIME.md` as a concise onboarding primer for future agents working in this repository.

The document covers:

- What Sinfonica is in this repo, including the critical self-hosting context that `maestro` orchestration code is maintained here.
...
Line count confirmation: `docs/SINFONICA_QUICK_PRIME.md` is 109 lines (<= 200).

## Artifacts

- Created: `docs/SINFONICA_QUICK_PRIME.md`
- Created: `.sinfonica/handoffs/s-20260302-001/return-02-coda.md`
...
1. If desired, link `docs/SINFONICA_QUICK_PRIME.md` from `docs/index.md` "Start Here" for discoverability.
